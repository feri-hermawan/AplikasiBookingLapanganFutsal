        ...
        <section>
            <div class="lg:flex lg:flex-row">
                <div class="mx-auto text-center">
                    <div class=" mx-auto w-[250px] h-[150px] bg-cover bg-center" style="background-image: url('/img/icons/Logo/bank-logo/bri-logo.jpg')"></div>
                    <span>Rek. BRI 0928373772883737 <br> (AN : Feri Hermawan)</span>
                </div>
            </div>
        </section>
