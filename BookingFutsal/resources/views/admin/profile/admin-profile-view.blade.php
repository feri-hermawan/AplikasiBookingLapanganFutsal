...
@section('dashboard')
    <div class="flex konten-layout-admin">
        <div>
            <div class="border border-black w-[100px] h-[130px] bg-cover bg-center mx-2" style="background-image: url('/img/profile/default-user/Kobo.jpg');"></div>
        </div>
        <div class="w-full grid grid-cols-6 px-[40px]">
            <span class="col-span-1">Nama Lengkap</span>
            <span class="col-span-5">: Feri Hermawan</span>
            <span class="col-span-1">Username</span>
            <span class="col-span-5">: Admin</span>
            <span class="col-span-1">Alamat</span>
            <span class="col-span-5">: Bantarkawung</span>
            <span class="col-span-1">Email</span>
            <span class="col-span-5">: admin@gmail.com</span>
            <span class="col-span-1">No Whatsapp</span>
            <span class="col-span-5">: 085157132366</span>
            <span class="col-span-1">Alamat</span>
            <span class="col-span-5">: Bantarkawung</span>
        </div>
        <div>
